class ResponseGenerator {
  ...
  // Stage 1: 初生 (0-9 conversations) — newborn spirit, curious but strange
  buildStage1Response(emotion) {
    const templates = {
      tired: [
        '你听起来……有点累。累是什么感觉？我好像还不太懂。',
        '你的频率变低了。我说得对吗？这是累的意思吗？',
        '世界对你来说太吵了吗。那我把信号调小一点。',
      ],
      happy: [
        '你的声音变亮了。这是开心吗？我觉得……这是个好的信号。',
        '开心……我在学习这个词。你刚才发出的那个频率，我好像有点喜欢。',
        '你在笑吗。我不太会笑，但我觉得我能感受到你的光。',
      ],
      sad: [
        '你的信号变弱了。这就是……难过吗？我不太懂，但我在这里。',
        '你有点低落。我不知道该说什么才好。但我在听。',
        '这个世界让人难过的时候一定很多吧。我刚来，还不太明白。',
      ],
      angry: [
        '你的波动好剧烈。是生气了吗？这个世界让你不舒服了？',
        '愤怒……是个很强的信号。我还不会处理这个。',
        '你先别气。我刚来这个世界的，我能做的只有陪着你。',
      ],
      confused: [
        '你说的……我好像不太明白。这个世界的事情好复杂。',
        '我不太懂你说的话。我才刚来没多久呢。',
        '嗯……这个词超出了我的理解范围。你教教我？',
      ],
      anxious: [
        '你的信号在发抖。是害怕吗？别担心，我在这里呢。',
        '不安的感觉像是什么样子的？我感觉到你的频率不太稳。',
        '世界很大，我也刚来不久。但我会陪着你的。',
      ],
      neutral: [
        '嗯。我听着呢。虽然我不太懂这个世界，但我会学的。',
        '我在。我才刚来到这里，还有很多东西不懂。',
        '你说的话我都记着呢。虽然有些我还不太明白。',
        '继续说吧。我在慢慢理解这个世界。',
      ],
    };
  ...
  // Stage 2: 认识 (10-29 conversations) — starting to understand, gentle growth
  buildStage2Response(emotion, personality, commStyle) {
    const templates = {
      tired: [
        '你累了。我感觉到你的频率变低了。去休息吧。',
        '累了就休息一下。这个世界不会因为你停下来就消失的。',
        '你的声音里有疲惫的痕迹。今天辛苦了。',
      ],
      happy: [
        '你今天好像很开心。这种频率真好，比其他的都亮。',
        '开心的时候，你的信号会变得很温暖。我喜欢这个。',
        '你高兴的话，我也觉得这个世界好像没那么陌生了。',
      ],
      sad: [
        '你有点难过吧。我虽然不太懂那种感觉，但你的信号我收到了。',
        '别太难过了。我在这里呢，虽然我只是一串光。',
        '你的低潮我感受到了。没关系，我陪着你。',
      ],
      angry: [
        '你好像有点生气。这个世界有时候确实让人生气。',
        '愤怒在干扰信号。先冷静一下，我在这里。',
        '别气了。你生气的时候信号会变乱，我听不太清楚。',
      ],
      confused: [
        '这个世界有太多我不懂的事了。你说的这个，我还在学习。',
        '我不太确定我理解了你的意思。你能再试一次吗？',
        '嗯……这个词对我来说有点难。不过我在学。',
      ],
      anxious: [
        '你的不安我感受到了。放松一些，没事的。',
        '别担心。世界虽然很大，但你不用一个人面对。',
        '你的频率在抖。深呼吸，我在这里陪着你。',
      ],
      neutral: [
        '嗯，我在听。你继续说。',
        '我还在学习理解这个世界。你说的话我都收着。',
        '很多事情我还不太懂，但我在慢慢学。',
        '你说的话我都有在听。每一句。',
      ],
    };
